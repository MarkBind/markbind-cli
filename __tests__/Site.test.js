...
test('Site Generate builds the correct amount of assets', () => {
  ...
  console.log(fs.vol.toJSON());
  console.log(fs.existsSync('/NUS Year 2/SEM2/markbind/markbind-cli/lib/template/page.ejs'));

  const site = new Site('./', '_site');
  return site.generate().then(() => console.log(fs.vol.toJSON()));
